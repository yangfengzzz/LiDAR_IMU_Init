...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void process(const livox_ros_driver::CustomMsg::ConstSharedPtr &msg, PointCloudXYZI::Ptr &pcl_out);
  void process_cut_frame_livox(const livox_ros_driver::CustomMsg::ConstSharedPtr &msg, deque<PointCloudXYZI::Ptr> &pcl_out, deque<double> &time_lidar, const int required_frame_num, int scan_count);
